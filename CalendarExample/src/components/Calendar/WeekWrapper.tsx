...
function WeekWrapper({children, style={}, ...other}:WeekWrapperProps):ReactElement {
  return ( 
    <View collapsable={false} style={[{ flexDirection: 'row', justifyContent: 'space-between' },style]} {...other}>
      {children}
    </View>
  );
}
